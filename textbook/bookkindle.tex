...
\usepackage[colorlinks,linkcolor=blue,urlcolor=blue,citecolor=blue,
 bookmarksopen=true,
 pdfauthor={Michael J. Dinneen}, 
 pdfsubject={CS220 Textbook},
 pdftitle={Introduction to Algorithms, Data Structures and Formal Languages},
...
{\medskip \noindent{\textsc{\textbf{Solution to Exercise~\ref{#1} on
page~\pageref{#1}}}}:\newline }
...
\include{intro/intro4}
\include{intro/intro3}
\include{intro/intro2}
\include{intro/intro}

\part{Introduction to Algorithm Analysis}

\include{algorithm-analysis/alg-anal}
\include{algorithm-analysis/sort}
\include{algorithm-analysis/search}

\part{Introduction to Graph Algorithms}
\renewcommand{\rm}{} % quick fix for ignoring \rm in ipe figures 

\include{graph-algorithms/graphadt}

\include{graph-algorithms/traversals}

\include{graph-algorithms/optimization}

\if 01 % not used in CS220 any more
\part{Introduction to Formal Languages}

\include{automata-grammars/automata}

\include{automata-grammars/grammars}
\fi
