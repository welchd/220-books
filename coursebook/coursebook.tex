...
\newcommand{\truevspace}[1]{ %Call this maccro to get a vertical space of #1 cm
\newcount\Scount
\Scount=0
\loop\vspace*{1cm}\par\goodbreak\advance\Scount by 1 \ifnum\Scount< #1 \repeat
}

\def\beginboxedexample{\begin{mdframed}
 \begin{Example}
 }
\def \endboxedexample #1 {\vspace{#1}
\end{Example}
\end{mdframed}
}
