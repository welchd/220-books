...
\algfont{fastfib} to compute $F(n)$ has the form $An + B$ for some constants $A, B$.
What about \algfont{slowfib}?
\end{Boxample}
...
\end{algorithmic}
\end{algorithm}
\Cref{alg:swap} \defnfont{swap} is a constant time algorithm.
% \end{Boxample}
