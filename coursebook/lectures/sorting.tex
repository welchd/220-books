...
\end{center}
\hfill\footnotesize More examples on \url{https://tinyurl.com/220drills}
\end{Boxample}
...
\section{Extra: How can we improve insertion sort?}
...
\section{Extra: dealing with floors and ceilings, etc}
...
\section{Extra: How do we solve the Fibonacci recurrence?}
...
\section{Extra: Quicksort recurrence solution}
