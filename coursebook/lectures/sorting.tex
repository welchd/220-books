...
\paragraph{What are the best and worst-case inputs?}
...
\paragraph{What happens if we do quicksort on a linked list?}
...
Choosing an element uniformly at random gives a \emph{randomized} 
...
So, what can be said about the depth of the leaves in a binary tree with 
$n$ nodes?

jo-TODO need picture, why commented out?

%\frametitle{Selection sort decision tree for $n=3$}
%\includegraphics[width=9cm]{pictures/selsort-dt}

%\frametitle{Insertion sort decision tree for input of size 3}
%\includegraphics[width=8cm]{pictures/insort}
...
% Write a sorting algorithm (in pseudeo-code) utilising $Q$. 
% \end{Boxample}
