...
\paragraph{What happens if we run selection sort on a linked list?}
...
\begin{Example}[6]
jo - TODO picture of heap and non-heap
\end{Example}
...
\begin{Example}[6]
jo - TODO picture example of heap insertion and deletion
\end{Example}
...
\begin{Boxample}[6]
jo - TODO draw heap and get them to convert to array
\end{Boxample}
...
\begin{Boxample}[4]
jo-TODO execution of this algorithm 
...
Table~\ref{t:sortchar} gives a summary of results so far on sorting algorithms.
...
\paragraph{Selection.}
We want to consider a related but different topic, Fix $r$ with $1\leq r \leq n$. We want to find the element with
...
jo-TODO Boxample needed, execute qselect
