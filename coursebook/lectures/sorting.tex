...
\begin{center}
  \includegraphics{QuickSortExample}
\end{center}
\end{Example}
...
TODO check $H_n$ defined earlier
...
jo-TODO $n=4$ example with some differences - do two inputs if needed
...
\begin{center}
\includegraphics{heapInsertDelete}
\end{center}
\end{Example}
...
\begin{Example}\label{ex:heapbuild}
...
\pagebreak[4]
\begin{Boxample}[0]
Heapsort on the already build heap from Example~\ref{ex:heapbuild}. 
...
TODO add something about sorting in practice, as we do for BST and hashing.
