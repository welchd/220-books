...
\end{center}
\end{Boxample}
jo-TODO I am not sure how useful the above example is - what are they supposed to notice?
...
\begin{Boxample}[6]
How does the solution to \cref{eg:recur-cov} look if we don't do the change of variable?
...
Quicksort was described briefly in \cref{sec:mergesort}. We give the details now.
...
\frac{2}{j}\right) = 4(H_{n+1} - (1+1/2)) - 2(H_n - 1)\dots = 2H_n + \frac{4}{n+1}.$$
...
algorithm (see Wikipedia, ``Median of medians") that is worst-case linear, 
