...
\begin{Boxample}[4]
Convince yourself the the following procedure finds the shortest directed cycle through node $v$ in a digraph, state how it can be used to find the directed girth and find the running time for doing so.
\begin{enumerate}
