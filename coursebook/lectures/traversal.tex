...
\item List nodes of $G$ in order of finishing (from first finished to last). This is a reverse topological order of $G$.
\item Run DFS on $G$, always choosing a root (starting) node as the unvisited node that occurs first on the list in the previous step.
