...
To see this consider the digraph in Example \ref{ex:tarjan} with the  arc $(3,2)$ removed. Start DFS from node zero and follow this alternative algorthim to see that you do not recover the strong components of the digraph. 
\end{Boxample}
