...
However, if we always use the same side for deletion, this can lead to unbalance. Alternating sides, or choosing a side randomly, will more likely  result in a more 
balanced tree.
...
of comparable size. We define the \defnfont{load factor} to be $\lambda := n/m$. 
