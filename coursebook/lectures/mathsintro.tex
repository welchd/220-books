...
\begin{itemize}
\item \defnfontX{Ceiling}\index{ceiling} rounds up to nearest integer, e.g. $\lceil 3.7 \rceil = 4 = \lceil 4 \rceil$.
\item \defnfontX{Floor}\index{floor} rounds down, e.g. $\lfloor 3.7 \rfloor = 3 = \lfloor 3 \rfloor$.
\end{itemize}
...
\defnfontX{Mathematical induction}\index{mathematical induction} is a standard technique for proving a collection of results, one for each natural number. 
